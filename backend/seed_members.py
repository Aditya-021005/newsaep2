...
def restore():
    print("🚀 Starting Team Restoration...")
    count = 0
    for entry in DATA:
        year = int(entry['year'])
        for raw_name in entry['members']:
            # Parse role from parentheses (e.g., "Name (Editor)")
            role = ""
            name = raw_name
    ...
    print(f"✅ Restoration complete! {count} members restored.")
