...
IMAGE_POOLS = {
    ...
    'Culture': [
        '1499591934245-40b55745b905',
        '1518929458119-e57a8971ad1f',
        '1536440136628-849c177e76a1'
    ],
    'Urban': [
        '1449824913935-59a9fe5c202b',
        '1477332552946-cfb384afaf1a',
        '1477959858617-67f85cf4f1df'
    ],
    'Legacy': [
        '1549144464-9eb5f073ea7d',
        '1501139083538-0139583c060f',
        '1526304640581-d33a68df4149'
    ]
}
...
for i in range(100):
    ...
    Article.objects.create(
        ...
        category=cat,
        published_date=now - timedelta(hours=random.randint(1, 48 * 14))
    )
